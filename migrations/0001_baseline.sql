-- 0001 - baseline.
--
-- The schema as it stood before this directory existed, captured with
--   pg_dump --schema-only --no-owner --no-privileges
--
-- An existing database already has all of this. Record it as applied without
-- running it:
--
--   npm run migrate -- baseline
--
-- A new one gets it by running the migration normally.
