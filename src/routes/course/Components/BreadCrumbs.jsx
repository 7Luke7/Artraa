...
export const BreadCrumbs = (props) => {
    return <nav class="mb-4" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center space-x-2 text-sm" itemscope itemtype="https://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                <A
                    href={`${import.meta.env.VITE_URL}/courses/?category=${props.cp.parent_category_slug}`}
                    class="inline-flex items-center text-gray-600 hover:text-gray-900"
                    itemprop="item"
                >
                    <span itemprop="name" class="font-gsans font-normal">
                        {props.cp.parent_category_name}
                    </span>
                </A>
