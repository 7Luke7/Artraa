...
export const NotEntrolledUI = ({data}) => {
    ...
    return <>
            ...
            <div class="w-full md:w-10/12 px-2 sm:px-4 md:px-6 mx-auto flex-1">
                <Header />
                <nav class="flex items-center gap-2 text-sm text-gray-500 font-gsans py-4" aria-label="breadcrumb">
                    <A href="/" class="hover:text-[#E85A4F] transition-colors">მთავარი</A>
